...
tablePresenter.list = function () {
    ...
    request.post(rest.cli.cliente.findall_uri, dataInput).then(function (data) {
...
modalPresenter.submit = function () {
    ...
    self._view.apply(function (data1) {
        ...
        var id = self._view.ui.find("input[name='cliente[id]']").val();
        var route = (id > 0) ? rest.cli.cliente.update1_uri : rest.cli.cliente.create_uri;
...
modalPresenter.delete = function () {
    ...
    if (id > 0) {
        ...
        confirmMsg(NOTIFIERS.MESSAGES.DELETECONFIRM, function (dataConfirm) {
            if (dataConfirm) {
                request.post(rest.cli.cliente.delete_uri, {cliente: {id: parseInt(id)}}).then(function (data) {
...
modalPresenter.openEdit = function () {
    ...
    if (id > 0) {
        ...
        request.post(rest.cli.cliente.findByIdedit_uri, {cliente: {id: parseInt(id)}}).then(function (data) {
            if (data.result == 0)
            {
                self._view.fillDataModalcli(data.cliente);
...
filterPresenter.submit = function () {
    ...
    {
        request.post(rest.cli.cliente.findall_uri, dataSerialize).then(function (data) {
